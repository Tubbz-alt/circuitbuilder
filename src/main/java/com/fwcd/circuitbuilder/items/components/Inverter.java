...
public class Inverter extends BasicComponent {
	private static final ResourceImage IMAGE_ENABLED = new ResourceImage("/inverterOn.png");
	private static final ResourceImage IMAGE_DISABLED = new ResourceImage("/inverterOff.png");
