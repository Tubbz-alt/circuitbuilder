...
public class CircuitBuilderGsonFactory {
    ...
    static {
        GsonBuilder gson = new GsonBuilder()
            ...
            .registerTypeAdapterFactory(RuntimeTypeAdapterFactory.of(Circuit1x1ComponentModel.class)
            ...
            .registerTypeAdapterFactory(RuntimeTypeAdapterFactory.of(CircuitLargeComponentModel.class)
